...
fun InputPassword(
    ...
    var passwordType by remember { mutableStateOf(false) }
    ...
    Column(
        ...
        BasicTextField(
            ...
            decorationBox = { innerTextField ->
                Row(
                    ...
                    Icon(
                        ...
                        painter = painterResource(if (passwordType) R.drawable.eye_code else R.drawable.hide_eye_code),
            ...
            visualTransformation = if (passwordType) VisualTransformation.None else PasswordVisualTransformation(),
